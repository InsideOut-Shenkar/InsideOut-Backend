...
class KNNDataProcessor:
    ...
    def find_nearest_neighbor(self, n_neighbors=5):
        ...
        mid_time1 = time.time()
        print(f"Time to find relevant columns: {mid_time1 - start_time:.2f} seconds")
        
        df_copy = self.df_copy.dropna(subset=relevant_columns)
        
        mid_time2 = time.time()
        print(f"Time to drop NA: {mid_time2 - mid_time1:.2f} seconds")
        ...
        mid_time3 = time.time()
        print(f"Time to process relevant columns: {mid_time3 - mid_time2:.2f} seconds")
        ...
        mid_time4 = time.time()
        print(f"Time to fit KNN: {mid_time4 - mid_time3:.2f} seconds")
        ...
        mid_time5 = time.time()
        print(f"Time to find nearest neighbors: {mid_time5 - mid_time4:.2f} seconds")
        ...
        mid_time6 = time.time()
        print(f"Time to evaluate nearest neighbors: {mid_time6 - mid_time5:.2f} seconds")
        ...
        # inverse transform the row to get the original values
        result = self.inverse_transform_row(row)
        
        end_time = time.time()
        print(f"Time to inverse transform row: {end_time - mid_time6:.2f} seconds")
